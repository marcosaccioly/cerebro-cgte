# Questionário de Onboarding -- 07-institucional

<!-- Lido quando o usuário digita "setup" dentro deste workspace.
     Este é o onboarding do servidor da área de Institucional. Preenche os 4 arquivos
     de contrato com o conteúdo real, validado pelo gestor. -->

## Antes de começar

Você está ativando o especialista **07-institucional** (Institucional). Esta sessão dura ~3h e produz:
