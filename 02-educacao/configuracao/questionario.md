# Questionário de Onboarding -- 02-educacao

<!-- Lido quando o usuário digita "setup" dentro deste workspace.
     Este é o onboarding do servidor da área de Educação. Preenche os 4 arquivos
     de contrato com o conteúdo real, validado pelo gestor. -->

## Antes de começar

Você está ativando o especialista **02-educacao** (Educação). Esta sessão dura ~3h e produz:
