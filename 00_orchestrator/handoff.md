...
## Formato de saída (o handoff que eu escrevo)
...
status: open
ask: "Distribuir produção visual do evento ABC (banners + identidade), prazo 2026-05-25."
payload:
  routing_rationale:
...
Para três exemplos completos cobrindo as três chains (tarefa própria, distribuir, extraordinária), ver `examples.md`.
