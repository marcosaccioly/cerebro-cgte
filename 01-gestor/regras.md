...
- **Para `demanda_extraordinaria`: registrar a decisão.** Criou nova categoria? Atualize também `_configuracao/regras-negocio.md` e `reference/taxonomia-board-47.md`. Recusou? Por que. Redirecionou? Para onde.
