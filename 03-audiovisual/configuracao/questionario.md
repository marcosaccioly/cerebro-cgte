# Questionário de Onboarding -- 03-audiovisual

<!-- Lido quando o usuário digita "setup" dentro deste workspace.
     Este é o onboarding do servidor da área de Audiovisual. Preenche os 4 arquivos
     de contrato com o conteúdo real, validado pelo gestor. -->

## Antes de começar

Você está ativando o especialista **03-audiovisual** (Audiovisual). Esta sessão dura ~3h e produz:
