...
Workspace MWP do especialista de **Acessibilidade** do cerebro-cgte. **ESQUELETO V0** -- ativação prevista em V1+ via sessão de ~3h com o servidor da área + gestor.

Cobertura: Acessibilidade, Libras Interpretação, Libras Tradução.
