# Questionário de Onboarding -- 05-acessibilidade

<!-- Lido quando o usuário digita "setup" dentro deste workspace.
     Este é o onboarding do servidor da área de Acessibilidade. Preenche os 4 arquivos
     de contrato com o conteúdo real, validado pelo gestor. -->

## Antes de começar

Você está ativando o especialista **05-acessibilidade** (Acessibilidade). Esta sessão dura ~3h e produz:
