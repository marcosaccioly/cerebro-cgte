/**
 * sincronizar.ts -- bridge git com HITL em arquivos sensiveis.
 *
 * Uso:
 ...
 *
 * As regras de sensibilidade vivem em sincronizar.md. Esta implementação mantem
...
async function main(): Promise<void> {
  ...
  switch (cmd) {
    ...
    case "pull":
      ...
      break;
    default:
      console.error("Uso: bun run sincronizar.ts <pull|push|status>");
      process.exit(2);
  }
}
