 ...
 *
 * Uso:
 *   bun run _pontes/kanboard/facade.ts <operação> [opcoes]
 *
 * Exemplos:
 *   bun run facade.ts criar-tarefa --case CASO-2026-0001-validacao-v0
 ...
 * formalidade vazia.
 */
export async function requireHitl(carga: unknown, descricao: string): Promise<boolean> {
  console.log("\n=== HITL ===");
