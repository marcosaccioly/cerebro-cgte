# Questionário de Onboarding -- 08-ciencia

<!-- Lido quando o usuário digita "setup" dentro deste workspace.
     Este é o onboarding do servidor da área de Ciência. Preenche os 4 arquivos
     de contrato com o conteúdo real, validado pelo gestor. -->

## Antes de começar

Você está ativando o especialista **08-ciencia** (Ciência). Esta sessão dura ~3h e produz:
