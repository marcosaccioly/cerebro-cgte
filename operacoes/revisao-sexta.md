...
- **Formato:** primeiros 15 minutos -- gestor escaneia cases ativos contra `padroes-qualidade.md`. Últimos 15 minutos -- conversa do time sobre padrões que surgiram (em V0 com so o gestor, fica registrado por escrito; em V1+ vira conversa real com a equipe).
...
- CASO-YYYY-NNNN-shortslug: STATUS -- resumo em uma linha, ação, owner. Reconferir quando.
...
- Categoria nova adicionada ao board 47? Documentar e cross-reference para `_configuracao/regras-negocio.md` e `01-gestor/referencias/taxonomia-board-47.md`.
- Chain nova adicionada ao `cadeias-fluxo.yaml`?
...
- CASO-2026-0002-slides-mooc-x: OK -- card no board, em execução, prazo 23/05. Reconferir segunda 25/05.
- CASO-2026-0003-noticia-programa-y: AT RISK -- Servidora A não confirmou aceite até quinta. Marquito mandou mensagem.
- CASO-2026-0001-validacao-v0: closed -- chain end-to-end rodou.

### O que mudou esta semana

- Fechados: CASO-2026-0001-validacao-v0 (chain V0 validada).
- Novos: CASO-2026-0002-slides-mooc-x, CASO-2026-0003-noticia-programa-y, CASO-2026-0004-piloto-ia-revisao.
- HITL recusados: 1 -- EN-002 do CASO-2026-0005 inicialmente recusado por categoria errada. Re-emitido com categoria correta.
...
- [ ] Confirmar com Servidora A o aceite no CASO-2026-0003 (owner: gestor, due: 2026-05-26)
...
Entradas acumulam, novas no topo. Após uns 6 meses (~25 entradas), o gestor pode arquivar entradas antigas em `operacoes/_archive/friday-reviews-YYYY-Q.md` e comecar live fresco.
